    ...
    public class PlPlayerParam : IVerticalStruct {
        public VerticalStruct Generate() { // .plp
            ...
            var entries = new List<MhwStructData.Entry> {
                ...
                new MhwStructData.Entry("Stamina Consumption: SA Wild Swing", 492, typeof(float)),
                ...
                new MhwStructData.Entry("Stamina Consumption: Claw Attack 1", 532, typeof(float)),
                new MhwStructData.Entry("Stamina Consumption: Claw Attack 2", 536, typeof(float)),
                new MhwStructData.Entry("Stamina Consumption: Claw Attack 3", 540, typeof(float)),
                new MhwStructData.Entry("Stamina Consumption: Claw Attack 4", 544, typeof(float)),
                ...
                new MhwStructData.Entry("Stamina Time Reduce mCore: Hammer/Bow Charge Drain", 568, typeof(float)),
                ...
                new MhwStructData.Entry("Stamina Time Reduce mCore: Clutch Drain (Whilst Grappled)", 596, typeof(float)),
            ...
            entries.AddRange(new List<MhwStructData.Entry> {
                ...
                new MhwStructData.Entry("WP MR Wyrmstake Blast Health Regen", 8663, typeof(float)),
