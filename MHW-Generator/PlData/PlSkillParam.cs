    ...
    public class PlSkillParam : IVerticalStruct {
        public VerticalStruct Generate() { // .plsp
            ...
            entries.AddRange(new List<MhwStructData.Entry> {
                ...
                new MhwStructData.Entry("Safi: Recovery Interval", 2009, typeof(float)),
                new MhwStructData.Entry("Safi: Recovery Amount", 2013, typeof(float)),
                new MhwStructData.Entry("Safi: Recovery Time", 2017, typeof(float)),
