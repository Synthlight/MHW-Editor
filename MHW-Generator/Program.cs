...
namespace MHW_Generator {
    public static partial class Program {
        ...
        private static void GenAwakenedWpUpgrade() {
            GenerateItemProps("MHW_Editor.Weapons", "AwakenedWpUpgrade", new MhwStructData { // .em104wud
                size = 10,
                offsetInitial = 10,
                entryCountOffset = 6,
                uniqueIdFormula = "{Index}",
        ...
        private static void GenAwakenedLimitBreak() {
            GenerateItemProps("MHW_Editor.Weapons", "AwakenedLimitBreak", new MhwStructData { // .em104lb
                ...
                entries = new List<MhwStructData.Entry> {
                    ...
                    new MhwStructData.Entry("Lvl 3 Id", 21, typeof(ushort)),
                    new MhwStructData.Entry("Lvl 4 Id", 23, typeof(ushort)),
                    new MhwStructData.Entry("Lvl 5 Id", 25, typeof(ushort)),
                    new MhwStructData.Entry("Works on Great Sword", 27, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Sword & Shield", 28, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Dual Blades", 29, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Long Sword", 30, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Hammer", 31, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Hunting Horn", 32, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Lance", 33, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Gunlance", 34, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Switch Axe", 35, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Charge Blade", 36, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Insect Glaive", 37, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on Bow", 38, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on HBG", 39, typeof(byte), typeof(bool)),
                    new MhwStructData.Entry("Works on LBG", 40, typeof(byte), typeof(bool)),
        ...
        private static void GenAnimalSize() {
            GenerateItemProps("MHW_Editor.Monsters", "AnimalSize", new MhwStructData { // .ransz
                size = 72,
                offsetInitial = 10,
                entryCountOffset = 6,
                uniqueIdFormula = "{Index}",
        ...
        private static void GenRoomFurniture() {
            GenerateItemProps("MHW_Editor.Items", "RoomFurniture", new MhwStructData { // .rfur
                size = 47,
                offsetInitial = 10,
                entryCountOffset = 6,
                uniqueIdFormula = "{Index}",
        ...
        private static void GenMonsterEnrage() {
            GeneratePlDataProps("MHW_Editor.Monsters", "MonsterEnrage", new MhwStructData { // .dtt_agr
                ...
                entries = new List<MhwStructData.Entry> {
                    ...
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (90%-100%)", 36, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (80%-90%)", 40, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (70%-80%)", 44, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (60%-70%)", 48, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (50%-60%)", 52, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (40%-50%)", 56, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (30%-40%)", 60, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (20%-30%)", 64, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (10%-20%)", 68, typeof(float)),
                    new MhwStructData.Entry("LR/HR Build Multiplier by HP (0%-10%)", 72, typeof(float)),
                    ...
                    new MhwStructData.Entry("MR Build Multiplier by HP (90%-100%)", 100, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (80%-90%)", 104, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (70%-80%)", 108, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (60%-70%)", 112, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (50%-60%)", 116, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (40%-50%)", 120, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (30%-40%)", 124, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (20%-30%)", 128, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (10%-20%)", 132, typeof(float)),
                    new MhwStructData.Entry("MR Build Multiplier by HP (0%-10%)", 136, typeof(float)),
        ...
        private static void GenItemDelivery() {
            GenerateItemProps("MHW_Editor.Items", "ItemDelivery", new MhwStructData { // .stmp
                size = 44,
                offsetInitial = 10,
                entryCountOffset = 6,
                uniqueIdFormula = "{Id}",
