    ...
    public class MonsterStamina : IMultiStruct {
        public MultiStruct Generate() { // .dtt_sta
            ...
            var staminaCount = new List<MhwMultiStructData.StructData.Entry> {
                new MhwMultiStructData.StructData.Entry("Number of Stamina Entries", typeof(uint), true).@out(out var count)
            };

            var structs = new List<MhwMultiStructData.StructData> {
                new MhwMultiStructData.StructData("Monster Stamina (1)", new List<MhwMultiStructData.StructData.Entry> {
                ...
                new MhwMultiStructData.StructData("Monster Stamina (2)", new List<MhwMultiStructData.StructData.Entry> {
                    new MhwMultiStructData.StructData.Entry("Fatigue Speed", typeof(float))
                }, 1)
            };
