        ...
        public MultiStruct Generate() { // .w03p
            ...
            structs.AddRange(new List<MhwMultiStructData.StructData> {
                new MhwMultiStructData.StructData($"W{N}p Params ({++paramIndex})", new List<MhwMultiStructData.Entry> {
                    ...
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 1", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 2", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 3", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 4", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 5", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 6", typeof(float)),
                    new MhwMultiStructData.Entry("Spirit Regeneration After Something, Unk 7", typeof(float)),
                    ...
                    new MhwMultiStructData.Entry($"Unk {unkIndex += 16}", typeof(float)),
                    new MhwMultiStructData.Entry($"Unk {++unkIndex}", typeof(float)),
                    new MhwMultiStructData.Entry($"Unk {++unkIndex}", typeof(float)),
                    new MhwMultiStructData.Entry($"Unk {++unkIndex}", typeof(float)),
