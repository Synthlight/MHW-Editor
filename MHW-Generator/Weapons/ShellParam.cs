        ...
        public MultiStruct Generate() { // .shlp
            ...
            var structs = new List<MhwMultiStructData.StructData> {
                ...
                new MhwMultiStructData.StructData("Shlp (1)", new List<MhwMultiStructData.Entry> {
                    new MhwMultiStructData.Entry("Particles: Projectile Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Projectile", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Muzzle Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Muzzle", typeof(uint)),
                ...
                new MhwMultiStructData.StructData("Shlp (2)", new List<MhwMultiStructData.Entry> {
                    new MhwMultiStructData.Entry("Particles: Ground Decal Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Ground Decal", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Wall Decal Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Wall Decal", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Obj Hit Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Obj Hit", typeof(uint)),
                    ...
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Gun Fire Header", typeof(uint)),
                    new MhwMultiStructData.Entry("Particles: Gun Fire", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
                    new MhwMultiStructData.Entry($"Unk {++i}", typeof(uint)),
