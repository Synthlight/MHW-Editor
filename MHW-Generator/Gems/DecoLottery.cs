...
namespace MHW_Generator.Gems {
    public class DecoLottery : SingleStructBase, IMultiStruct {
        public MultiStruct Generate() { // .diot
            ...
            return new MultiStruct("MHW_Editor.Gems", "DecoLottery", new MhwMultiStructData(structs, "diot"));
        }
    }
}