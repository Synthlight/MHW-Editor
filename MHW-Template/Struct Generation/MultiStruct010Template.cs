...
/// </summary>
private global::MHW_Template.Struct_Generation.MhwMultiStructData structData
{
    get
    {
...
{
    this._structDataField = ((global::MHW_Template.Struct_Generation.MhwMultiStructData)(this.Session["structData"]));
...
if ((structDataValueAcquired == false))
{
    ...
    if ((data != null))
    {
        this._structDataField = ((global::MHW_Template.Struct_Generation.MhwMultiStructData)(data));
    }
}
