...
using MHW_Editor.Structs.Otomo;
...
#pragma warning restore 162
        ...
        public static Type GetFileType(string targetFile) {
            ...
            if (fileName.EndsWith(".oprm")) return typeof(OtomoParam);
            if (fileName.EndsWith(".opst")) return typeof(Opst);
            if (fileName.EndsWith(".ot_lv")) return typeof(OtomoLevel);
            if (fileName.EndsWith(".ot_tlv")) return typeof(OtomoToolLevel);
