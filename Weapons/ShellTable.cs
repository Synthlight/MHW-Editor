...
namespace MHW_Editor.Weapons {
    public partial class ShellTable : MhwItem {
        ...
        static ShellTable() {
            ...
            reloadLookup.Add(18, "Normal Reload M1.4");
            ...
            reloadLookup.Add(7, "Very Slow Reload M2.3");
