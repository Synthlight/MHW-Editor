    ...
    public partial class PlPlayerParam {
        public ObservableCollection<PlDataItemCustomView> GetCustomView() {
            return new ObservableCollection<PlDataItemCustomView> {
                ...
                new PlDataItemCustomView(this, "------Skipping ahead.", "_Skipping_ahead__8300", Bytes, 3),
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__8350", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__11900", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "------Skipping ahead.", "_Skipping_ahead__13650", Bytes, 3),
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__13700", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__14750", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__16750", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__17500", Bytes, 3),
                ...
                new PlDataItemCustomView(this, "-------------------------------------------------------------------------------------------", "__17750", Bytes, 3),
                new PlDataItemCustomView(this, "------Skipping the rest.", "_Skipping_the_rest__17800", Bytes, 3),
            };
        }
    }
}