...
namespace MHW_Editor.Weapons {
    public partial class AwakenedLimitBreak {
        public const uint StructSize = 49;
        ...
        public virtual bool Has_Upgrade {
            get => (bool) Convert.ToBoolean(GetData<byte>(14));
            set {
                if (Convert.ToBoolean(GetData<byte>(14)) == value) return;
                SetData(14, Convert.ToByte(value), nameof(Has_Upgrade));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Previous_Upgrade_Id_When_Max_Lvl {
            ...
            set {
                ...
                SetData(15, value, nameof(Previous_Upgrade_Id_When_Max_Lvl));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Next_Upgrade_Id {
            ...
            set {
                ...
                SetData(17, value, nameof(Next_Upgrade_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Can_Stack {
            ...
            set {
                ...
                SetData(19, Convert.ToByte(value), nameof(Can_Stack));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Lvl_1_Id {
            ...
            set {
                ...
                SetData(21, value, nameof(Lvl_1_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Lvl_2_Id {
            ...
            set {
                ...
                SetData(23, value, nameof(Lvl_2_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Lvl_3_Id {
            ...
            set {
                ...
                SetData(25, value, nameof(Lvl_3_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Lvl_4_Id {
            ...
            set {
                ...
                SetData(27, value, nameof(Lvl_4_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual ushort Lvl_5_Id {
            ...
            set {
                ...
                SetData(29, value, nameof(Lvl_5_Id));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Great_Sword {
            ...
            set {
                ...
                SetData(31, Convert.ToByte(value), nameof(Works_on_Great_Sword));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Sword_Shield {
            ...
            set {
                ...
                SetData(32, Convert.ToByte(value), nameof(Works_on_Sword_Shield));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Dual_Blades {
            ...
            set {
                ...
                SetData(33, Convert.ToByte(value), nameof(Works_on_Dual_Blades));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Long_Sword {
            ...
            set {
                ...
                SetData(34, Convert.ToByte(value), nameof(Works_on_Long_Sword));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Hammer {
            ...
            set {
                ...
                SetData(35, Convert.ToByte(value), nameof(Works_on_Hammer));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Hunting_Horn {
            ...
            set {
                ...
                SetData(36, Convert.ToByte(value), nameof(Works_on_Hunting_Horn));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Lance {
            ...
            set {
                ...
                SetData(37, Convert.ToByte(value), nameof(Works_on_Lance));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Gunlance {
            ...
            set {
                ...
                SetData(38, Convert.ToByte(value), nameof(Works_on_Gunlance));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Switch_Axe {
            ...
            set {
                ...
                SetData(39, Convert.ToByte(value), nameof(Works_on_Switch_Axe));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Charge_Blade {
            ...
            set {
                ...
                SetData(40, Convert.ToByte(value), nameof(Works_on_Charge_Blade));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Insect_Glaive {
            get => (bool) Convert.ToBoolean(GetData<byte>(41));
            set {
                if (Convert.ToBoolean(GetData<byte>(41)) == value) return;
                SetData(41, Convert.ToByte(value), nameof(Works_on_Insect_Glaive));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_Bow {
            get => (bool) Convert.ToBoolean(GetData<byte>(42));
            set {
                if (Convert.ToBoolean(GetData<byte>(42)) == value) return;
                SetData(42, Convert.ToByte(value), nameof(Works_on_Bow));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_HBG {
            get => (bool) Convert.ToBoolean(GetData<byte>(43));
            set {
                if (Convert.ToBoolean(GetData<byte>(43)) == value) return;
                SetData(43, Convert.ToByte(value), nameof(Works_on_HBG));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public virtual bool Works_on_LBG {
            get => (bool) Convert.ToBoolean(GetData<byte>(44));
            set {
                if (Convert.ToBoolean(GetData<byte>(44)) == value) return;
                SetData(44, Convert.ToByte(value), nameof(Works_on_LBG));
                OnPropertyChanged(nameof(Raw_Data));
        ...
        public const int Unk28_sortIndex = 1450;
